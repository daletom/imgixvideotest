        ...
        <div class="hidden sm:block sm:ml-6">
          <div class="flex">
            <div class="relative flex ml-0">
              <nuxt-link to="/yourVideo" href="#" class="px-3 py-2 rounded-md text-3xl font-h2 font-medium leading-5 text-white hover:underline focus:outline-none transition duration-150 ease-in-out group link-style">Add Your Own Video URL</nuxt-link>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="block">
      <nav class="">
        <div class="ml-12">
          ...
          <nuxt-link @click.native="showMobileMenu = false" to="/yourVideo" class="mt-1 block px-3 py-2 rounded-md text-2xl font-h2 text-black hover:underline focus:outline-none transition duration-150 ease-in-out">Add Your Own Video URL</nuxt-link>
        </div>
      </nav>
    </div>
  </div>
